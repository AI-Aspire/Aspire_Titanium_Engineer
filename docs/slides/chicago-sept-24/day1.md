...
Sources: [Concrete Idea Worksheet](https://corporate.aiaspire.ai/accenture/titanium/NA/agenda/cohort_2/Concrete_Idea_Worksheet.pdf); [Charter template](../../../project/CHARTER.md).
-->
...
> Source: [Semantic contracts research notes](../../../../ctx-eng-book/research/semantic-contracts.md)
...
Sources: [Author's semantic-contract notes](../../../../ctx-eng-book/research/semantic-contracts.md); [Course authoring principles](../../AUTHORING.md).
-->
...
Sources: [Machine Learning Yearning](https://github.com/ajaymache/machine-learning-yearning/blob/master/full%20book/machine-learning-yearning.pdf); [Charter template](../../../project/CHARTER.md).
-->
...
Sources: [The LLM application stack](https://a16z.com/emerging-architectures-for-llm-applications/); [Course authoring principles](../../AUTHORING.md).
-->
...
Sources: [Machine Learning Yearning](https://github.com/ajaymache/machine-learning-yearning/blob/master/full%20book/machine-learning-yearning.pdf); [Prompt patterns module](../../../02_Prompt_Patterns/README.md).
-->
...
Sources: [Building effective agents](https://www.anthropic.com/engineering/building-effective-agents); [Module 01 production discussion](../../../01_Dev_Environment/Dev_Environment.ipynb).
-->
...
Sources: [The LLM application stack](https://a16z.com/emerging-architectures-for-llm-applications/); [Author's context-assembly notes](../../../../ctx-eng-book/research/context-assembly-pipeline-patterns.md).
-->
...
> Source: [Day 1 schedule](../../schedule/day1.md)
...
Sources: [Day 1 schedule](../../schedule/day1.md); [Day 1 cohort outline](README.md); [Concrete Idea Worksheet](https://corporate.aiaspire.ai/accenture/titanium/NA/agenda/cohort_2/Concrete_Idea_Worksheet.pdf).
-->
...
<!--
Slide ID: D1-M01-C1
Module: [01 Dev environment](../../../01_Dev_Environment/README.md)
...
Sources: [Module 01 overview](../../../01_Dev_Environment/README.md); [Module 01 notebook](../../../01_Dev_Environment/Dev_Environment.ipynb).
-->
...
> Source: [Module 01](../../../01_Dev_Environment/README.md)
...
Sources: [Module 01 overview](../../../01_Dev_Environment/README.md); [Module 01 workspace initialization](../../../01_Dev_Environment/Dev_Environment.ipynb); [Artifact integrity rules](../../../AGENTS.md).
-->
...
Sources: [GitHub flow](https://docs.github.com/en/get-started/using-github/github-flow); [Module 01 notebook](../../../01_Dev_Environment/Dev_Environment.ipynb).
-->
...
Sources: [Module 01 Learn/Create/Grow](../../../01_Dev_Environment/README.md); [GitHub flow](https://docs.github.com/en/get-started/using-github/github-flow).
-->
...
Sources: [GitHub protected branches](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-protected-branches/about-protected-branches); [Module 01 production discussion](../../../01_Dev_Environment/Dev_Environment.ipynb).
-->
...
<!--
Slide ID: D1-M02-C1
Module: [02 Prompt patterns](../../../02_Prompt_Patterns/README.md)
...
Sources: [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb).
-->
...
Sources: [Few-shot learners, Brown et al., 2020](https://arxiv.org/abs/2005.14165); [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb).
-->
...
Sources: [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb); [The LLM application stack](https://a16z.com/emerging-architectures-for-llm-applications/).
-->
...
Sources: [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb); [Author's semantic-contract notes](../../../../ctx-eng-book/research/semantic-contracts.md).
-->
...
Sources: [Chain-of-thought prompting, Wei et al., 2022](https://arxiv.org/abs/2201.11903); [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb).
-->
...
Sources: [ReAct, Yao et al., 2022](https://arxiv.org/abs/2210.03629); [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb).
-->
...
Sources: [Self-Refine, Madaan et al., 2023](https://arxiv.org/abs/2303.17651); [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb).
-->
...
> Source: [Prompt patterns notebook](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb)
...
Sources: [Prompt patterns Create/Grow](../../../02_Prompt_Patterns/Prompt_Patterns.ipynb); [Simple workflows versus agents](https://www.anthropic.com/engineering/building-effective-agents).
-->
...
<!--
Slide ID: D1-M03-C1
Module: [03 Agents 101](../../../03_Agents_101/README.md)
...
Sources: [Agent harness notebook](../../../03_Agents_101/Agent_Harness.ipynb); [Workflow and agent definitions](https://www.anthropic.com/engineering/building-effective-agents).
-->
...
Sources: [ReAct, Yao et al., 2022](https://arxiv.org/abs/2210.03629); [Agent harness tools](../../../03_Agents_101/Agent_Harness.ipynb).
-->
...
Sources: [Agent harness limits and trace](../../../03_Agents_101/Agent_Harness.ipynb); [Effective harnesses for long-running agents](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents).
-->
...
Sources: [Agent harness Create/Grow](../../../03_Agents_101/Agent_Harness.ipynb); [Building effective agents](https://www.anthropic.com/engineering/building-effective-agents).
-->
...
<!--
Slide ID: D1-M04-C1
Module: [04 Vibe checks and judges](../../../04_Vibe_Checks_and_Judges/README.md)
Instructor: Beric, code walkthrough
Type: core
Minutes: 2
Layout: 04 Icon cards
...
Sources: [Vibe checks and judges notebook](../../../04_Vibe_Checks_and_Judges/Vibe_Checks_LLM_Judge.ipynb); [LLM judge study, Zheng et al., 2023](https://arxiv.org/abs/2306.05685).
-->
...
Sources: [Judging LLM-as-a-Judge](https://arxiv.org/abs/2306.05685); [Strict judge implementation](../../../04_Vibe_Checks_and_Judges/Vibe_Checks_LLM_Judge.ipynb).
-->
...
Sources: [Three judge dimensions](../../../04_Vibe_Checks_and_Judges/Vibe_Checks_LLM_Judge.ipynb); [Ragas faithfulness definition](https://docs.ragas.io/en/stable/concepts/metrics/available_metrics/faithfulness/).
-->
...
Sources: [Disagreement analysis and responsible controls](../../../04_Vibe_Checks_and_Judges/Vibe_Checks_LLM_Judge.ipynb); [LLM judge limitations](https://arxiv.org/abs/2306.05685).
-->
...
Sources: [Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena](https://arxiv.org/abs/2306.05685); [Notebook calibration discussion](../../../04_Vibe_Checks_and_Judges/Vibe_Checks_LLM_Judge.ipynb).
-->
...
<!--
Slide ID: D1-M05-C1
Module: [05 RAG](../../../05_RAG/README.md)
Instructor: Beric, code walkthrough
Type: core
Minutes: 2
Layout: 05 Two column
...
Sources: [RAG, Lewis et al., 2020](https://arxiv.org/abs/2005.11401); [RAG notebook](../../../05_RAG/RAG_with_LangChain.ipynb).
-->
...
Sources: [RAG from scratch and library pipeline](../../../05_RAG/RAG_with_LangChain.ipynb); [Author's context-assembly notes](../../../../ctx-eng-book/research/context-assembly-pipeline-patterns.md).
-->
...
Sources: [RAG setup, top-k comparison, saved baseline](../../../05_RAG/RAG_with_LangChain.ipynb); [RAG artifact contract](../../../05_RAG/README.md).
-->
...
Sources: [RAG baseline](../../../05_RAG/RAG_with_LangChain.ipynb); [Agentic retrieval comparison](../../../07_Agentic_Retrieval/DCI_vs_Agentic_RAG.ipynb); [RAG versus long-context study](https://arxiv.org/abs/2407.16833).
-->
