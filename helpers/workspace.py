...
SCHEMA: dict[str, Artifact] = {a.name: a for a in [
    ...
    _A("traces", "ops/traces.jsonl", "jsonl", "22", ("span", "ms"),
       "Spans from one instrumented request path, in OpenTelemetry GenAI terms"),
    _A("load_test", "ops/load_test.csv", "csv", "22", ("concurrency", "req_per_s", "p50_ms"),
       "Throughput and latency of the model endpoint at rising concurrency"),
    _A("monitoring", "ops/monitoring.md", "md", "22", (),
       "The four metrics, the drift rule with its lag, and what may be logged"),
    _A("eval_gate", "demo/eval_gate.json", "json", "23", ("passed", "minimum"),
       "The result of running the release gate over the eval results"),
    _A("canary_verdict", "demo/canary_verdict.json", "json", "23", ("verdict",),
       "Promote, hold, or roll back, from a two-proportion interval"),
    _A("deploy_checklist", "demo/deploy_checklist.md", "md", "23", (),
       "The deployment questions, answered or marked unknown"),
